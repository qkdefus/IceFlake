...
namespace IceFlake.Scripts
{
    ...
    {
        public QKDrawMeshScript() 
            : base("_QKDrawMeshScript", "Drawing")
        {
        ...
        private static SlimDX.Direct3D9.StateBlock _SB = new SlimDX.Direct3D9.StateBlock(D3D.CurrDevice, StateBlockType.All);
        ...
        public void DrawTriangleList(SlimDX.Vector3 loc)
        {
            ...
            D3D.CurrDevice.VertexFormat = D3D.Vertex.Format;

            // Render the vertex buffer.
            D3D.CurrDevice.SetStreamSource(0, Vertices, 0, D3D.Vertex.SizeBytes);

            //D3D.CurrDevice.DrawPrimitives(PrimitiveType.LineStrip, 0, 1);
            D3D.CurrDevice.DrawPrimitives(PrimitiveType.TriangleList, 0, 1);
        ...
        private void DrawCircle(Location loc, float radius, System.Drawing.Color innerColor, System.Drawing.Color outerColor, int complexity = 24, bool isFilled = true)
        {
            ...
            D3D.CurrDevice.DrawUserPrimitives(SlimDX.Direct3D9.PrimitiveType.TriangleFan, buffer.Length - 2, buffer);
        }
        ...
        {
            if (_mesh == null)
                _mesh = SlimDX.Direct3D9.Mesh.CreateBox(D3D.CurrDevice, width, height, depth);

            _SB.Capture();

            //D3D.CurrDevice.Clear(ClearFlags.Target | ClearFlags.ZBuffer, System.Drawing.Color.Black, 1.0f, 0);
        ...
        public static void DrawLineVertex()
        {
            ...
            D3D.CurrDevice.VertexFormat = VertexFormat.Position | VertexFormat.Diffuse;
            D3D.CurrDevice.DrawUserPrimitives<LineVertex>(PrimitiveType.LineList,
                                                0,
                                                lineData.Length / 2,
                                                lineData);
        }
        ...
        public static void DrawLineList(Vector3 from, Vector3 to, Color4 color)
        {
            ...
            D3D.CurrDevice.DrawUserPrimitives(PrimitiveType.LineList, 1, vertices);
        }
        ...
        private void DrawLineStrip(SlimDX.Vector3 from, SlimDX.Vector3 to, Color4 color)
        {
            ...
            D3D.CurrDevice.DrawUserPrimitives(SlimDX.Direct3D9.PrimitiveType.LineStrip, vertices.Count - 1, buffer);
        }
        ...
        public static void Cleanup()
        {
            ...
            if (D3D.CurrDevice != null)
                D3D.CurrDevice.Dispose();
        }
