...
namespace IceFlake.Scripts
{
    ...
    public class QKDrawScriptV6 : Script
    {
        ...
        {
            if (_mesh == null)
                _mesh = SlimDX.Direct3D9.Mesh.CreateCylinder(D3D.CurrDevice, 3f, 3f, 10f, 20, 1);
            ...
            _light.Direction = new SlimDX.Vector3(0.0f, 0.0f, +10.0f);
            ...
            D3D.CurrDevice.SetRenderState(RenderState.Ambient, true);
            D3D.CurrDevice.SetRenderState(RenderState.Lighting, true);

            // Set an ambient light.
            //D3D.CurrDevice.SetRenderState(RenderState.Ambient, _colorAmbient.ToArgb());
